 ...
 */
final class Version20231211133041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client_adress (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, adresse_id INT NOT NULL, type_adress VARCHAR(1) NOT NULL, INDEX IDX_94A8C0DFB88E14F (utilisateur_id), INDEX IDX_94A8C0D4DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE preference (id INT AUTO_INCREMENT NOT NULL, type_notifications_id INT DEFAULT NULL, utilisateur_id INT NOT NULL, INDEX IDX_5D69B0535AD46130 (type_notifications_id), INDEX IDX_5D69B053FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, relai_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, num_tel VARCHAR(255) DEFAULT NULL, type_user VARCHAR(1) NOT NULL, INDEX IDX_8D93D64956931FB1 (relai_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_connexion (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, tokken VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, date_utilisation DATETIME NOT NULL, INDEX IDX_938B7478FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_login (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, identifian VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_48CA3048FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE client_adress ADD CONSTRAINT FK_94A8C0DFB88E14F FOREIGN KEY (utilisateur_id) REFERENCES `user` (id)');
        ...
        $this->addSql('ALTER TABLE user_connexion ADD CONSTRAINT FK_938B7478FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE user_login ADD CONSTRAINT FK_48CA3048FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES `user` (id)');
    }
